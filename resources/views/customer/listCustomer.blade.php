    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <form class="navbar-form navbar-left" action="{{route('customer_search')}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-8">
                ...
                @else
                    @foreach($customers as $key => $customer)
                        <tr>
                            ...
                            <td><a href="{{ route('customer_update', $customer->id) }}">sửa</a></td>
                            <td><a href="{{ route('customer_delete', $customer->id) }}" class="text-danger" onclick="return confirm('Bạn chắc chắn muốn xóa?')">xóa</a></td>
                        </tr>
                    @endforeach
                @endif
                </tbody>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-6">
                        <a class="btn btn-primary" href="{{ route('customer_add') }}">Thêm mới</a>
                        <a class="btn btn-primary" href="{{route('customer_list')}}">Back</a>
                    </div>
                    <div class="col-6">
        ...
        <div class="modal fade" id="cityModal" role="dialog">
            <div class="modal-dialog modal-lg">
                <!-- Modal content-->
                <form action="{{ route('customer_filterByCity') }}" method="get">
                    @csrf
